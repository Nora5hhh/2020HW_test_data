...
void searchEdge::multiSearch()
{
	...
	thread thread4(bind(&searchEdge::findRing, this, 3));
	thread thread5(bind(&searchEdge::findRing, this, 4));
	thread thread6(bind(&searchEdge::findRing, this, 5));
	thread thread7(bind(&searchEdge::findRing, this, 6));
	findRing(7);
	thread1.join();
	thread2.join();
	thread3.join();
