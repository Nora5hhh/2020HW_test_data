...
{
	resultPositionLast[threadId][0] = result1[threadId];
	resultPositionLast[threadId][1] = result2[threadId];
	resultPositionLast[threadId][2] = result3[threadId];
	resultPositionLast[threadId][3] = result4[threadId];
	resultPositionLast[threadId][4] = result5[threadId];
	while (true) {
		mtx.lock();
