...
{
	thread thread1(bind(&searchEdge::findRing, this, 0, 0, (unsigned int)firstIdCnt / 4));
	thread thread2(bind(&searchEdge::findRing, this, 1, (unsigned int)firstIdCnt / 4, 2 * (unsigned int)firstIdCnt / 4));
	thread thread3(bind(&searchEdge::findRing, this, 2, 2 * (unsigned int)firstIdCnt / 4, 3 * (unsigned int)firstIdCnt / 4));
	thread thread4(bind(&searchEdge::findRing, this, 3, 3 * (unsigned int)firstIdCnt / 4, (unsigned int)firstIdCnt));
	thread1.join();
	thread2.join();
	thread3.join();
	thread4.join();
