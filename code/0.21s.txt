...
{
	thread thread1(bind(&searchEdge::findRing, this, 0, 0, (unsigned int)(0.05 * idCnt)));
	thread thread2(bind(&searchEdge::findRing, this, 1, (unsigned int)(idCnt * 0.05), (unsigned int)(idCnt * 0.1)));
	thread thread3(bind(&searchEdge::findRing, this, 2, (unsigned int)(idCnt * 0.1), (unsigned int)(idCnt * 0.25)));
	//thread thread4(bind(&searchEdge::findRing, this, 3, (unsigned int)(idCnt * 0.25), (unsigned int)idCnt));
	findRing(3, (unsigned int)(idCnt * 0.25), (unsigned int)idCnt);
	thread1.join();
	thread2.join();
	thread3.join();
}
